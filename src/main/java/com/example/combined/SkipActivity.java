...
public class SkipActivity extends AppCompatActivity {
    ...
    private Button skipbtn, skip_login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skip_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent j = new Intent(SkipActivity.this, LoginTabUserFragment.class);
                startActivity(j);
            }
        });
        ...
        skipbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SkipActivity.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
